...
This file demonstrates PoSI on the Boston Housing data from @harrison1978hedonic with amendments by @gilley1996harrison.
...
After PoSI or PoSI1 adjustment, `RIVER` and `BLK` change from siginificant at 0.05 level to insignificant. The conslusion for the variable of interest does not change.
